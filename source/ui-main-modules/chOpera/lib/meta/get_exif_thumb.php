...
******************************************************************************/
      ...
      //  include_once 'EXIF.php';
       ...
       // if(!isset($filename))$filename = $_GET['filename'];
...
ob_start( );
        ...
        if ( $Exif_array === FALSE )
        {
                ...
                ob_end_clean ( );
                return "<p>EXIF segment could not be retrieved</p>\n";
                return;
        }
        ...
        {
                ob_end_clean ( );
                return "<p>Couldn't find Thumbnail IFD</p>\n";
               // return;
        }
        ...
        if ( array_key_exists( 513, $Exif_array[1] ) )
        {
                ...
                $res = base64_encode( $Exif_array[1][513]['Data']);
				return '<img src="data:image/png;base64,'.$res.'"/>';
        }
        else
        {
                ob_end_clean ( );
                return "<p>Couldn't find Thumbnail Tag</p>\n";
               // return;
        }
}
?>
