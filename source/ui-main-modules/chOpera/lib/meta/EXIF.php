        ...
        foreach( $IFD_array as $Tag_ID => $Exif_Tag )
        {
                ...
                else
                {
                             ...
                             ( $Tag_ID == 513 ) )
                        {
								...
								//include()
								//getThumb
                               // include get_relative_path( dirname(__FILE__) . "/get_exif_thumb.php" , getcwd ( ) );
                                //$link_str .= "?filename=";
                                ...
                                //$output_str .= "<tr class=\"EXIF_Table_Row\"><td class=\"EXIF_Caption_Cell\">" . $Exif_Tag['Tag Name'] . "</td><td class=\"EXIF_Value_Cell\">".getThumb($link_str)."</td></tr>\n";
                        }
